...
static inline std::unordered_map<TType, std::string> TokenType2Str {
  ...
  {TType::LIT_INT_U64, "LIT_INT_U64"},
  {TType::LIT_INT_U32, "LIT_INT_U32"},
  {TType::LIT_INT_U16, "LIT_INT_U16"},
  {TType::LIT_INT_U8, "LIT_INT_U8"},
  {TType::LIT_FLT, "LIT_FLT"},
  {TType::LIT_STR, "LIT_STR"},
  {TType::IDENT, "IDENT"},
  {TType::IDENT_VOID, "IDENT_VOID"},
  {TType::IDENT_INT, "IDENT_INT"},
  {TType::IDENT_INT_U64, "IDENT_INT_U64"},
  {TType::IDENT_INT_U32, "IDENT_INT_U32"},
  {TType::IDENT_INT_U16, "IDENT_INT_U16"},
  {TType::IDENT_INT_U8, "IDENT_INT_U8"},
  ...
  {TType::KW_INT, "KW_INT"},
  {TType::KW_INT_U64, "KW_INT_U64"},
  {TType::KW_INT_U32, "KW_INT_U32"},
  {TType::KW_INT_U16, "KW_INT_U16"},
  {TType::KW_INT_U8, "KW_INT_U8"},
...
static inline std::unordered_map<std::string_view, TType> Str2TokenKw {
  ...
  {"int", TType::KW_INT},        {"u64", TType::KW_INT_U64},
  {"u32", TType::KW_INT_U32},    {"u16", TType::KW_INT_U16},
  {"u8", TType::KW_INT_U8},      {"bool", TType::KW_BOOL},
