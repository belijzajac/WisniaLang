...
namespace Wisnia::Basic {
    ...
    static inline std::unordered_map<std::string, TType> StrToTokenKw = {
        {"fn", TType::KW_FN},
        {"class", TType::KW_CLASS},
        {"new", TType::KW_CLASS_INIT},
        {"def", TType::KW_CLASS_DEF},
        {"rem", TType::KW_CLASS_REM},
        {"return", TType::KW_RETURN},
        {"if", TType::KW_IF},
        {"elif", TType::KW_ELIF},
        {"else", TType::KW_ELSE},
        {"for", TType::KW_FOR},
        {"while", TType::KW_WHILE},
        {"for_each", TType::KW_FOREACH},
        {"in", TType::KW_FOREACH_IN},
        {"continue", TType::KW_CONTINUE},
        {"break", TType::KW_BREAK},
        {"true", TType::KW_TRUE},
        {"false", TType::KW_FALSE},
        {"read", TType::KW_READ},
        {"print", TType::KW_PRINT},
        {"void", TType::KW_VOID},
        {"int", TType::KW_INT},
        {"bool", TType::KW_BOOL},
        {"float", TType::KW_FLOAT},
